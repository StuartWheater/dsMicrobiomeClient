...
## Demo sequence ds.diversity_assign

```{r}
ds.diversity_assign(data.name="F", newobj="A", datasources=conns)
...
## Demo sequence ds.diversity

```{r}
res <- ds.diversity(data.name="F", datasources=conns)
